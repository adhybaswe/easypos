            ...
            <View style={styles.bodyContainer}>
                ...
                <View style={styles.floatingCard}>
                    <TouchableOpacity style={styles.floatingAction} onPress={() => router.push('/(app)/pos')}>
                        ...
                        <Text style={styles.floatingLabel}>{t.pos}</Text>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <Text style={styles.floatingLabel}>{t.history}</Text>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <Text style={styles.floatingLabel}>{t.statsLabel}</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.floatingAction} onPress={() => router.push('/(app)/settings')}>
                        <View style={[styles.floatingIconCircle, { backgroundColor: '#FCE7F3' }]}>
                            <Ionicons name="settings" size={24} color="#EC4899" />
                        </View>
                        <Text style={styles.floatingLabel}>{t.setting}</Text>
                    </TouchableOpacity>
                </View>
                    ...
                    <View style={{ marginTop: 20 }}>
                        ...
                        <View style={styles.menuGrid}>
                            ...
                            >
                                ...
                                <Text style={styles.menuItemText}>{t.manageDiscounts}</Text>
                            </TouchableOpacity>
                        </View>
